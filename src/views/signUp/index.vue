...
export default {
    ...
    methods: {
        ...
        sendVcodeRequset() {
            // let url = 'http://3s.dkys.org:24789/user/userRegistStepOne?name=' + this.ruleForm.name + '&email=' + this.ruleForm.email + '&password=' + this.ruleForm.pass;
            // let url = 'http://3s.dkys.org:24789/user/userRegistStepOne';
            let url = 'http://172.20.10.2:8080/user/userRegistStepOne';
        ...
        register() {
            let url = 'http://3s.dkys.org:24789/user/userRegistStepTwo?Vcode=' + this.ruleForm.vCode;
            axios({
                methods: 'post',
                url: url
            }).then(res => {
                if (res.data.code === 200006 || 200011) {
                    this.$alert(res.data.msg, '错误', {
                        confirmButttonText: '确定'
                    });
                } else if (res.data.code === 100001) {
